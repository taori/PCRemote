        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProgramPath = table.Column<string>(type: "TEXT", maxLength: 512, nullable: false),
                    Arguments = table.Column<string>(type: "TEXT", maxLength: 1024, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                name: "VoiceRecognitionConfiguration",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VoiceRecognitionConfiguration", x => x.Key);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SubjectId = table.Column<string>(type: "TEXT", maxLength: 40, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    UserId = table.Column<string>(type: "TEXT", nullable: false),
                    RefreshTokenId = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false),
