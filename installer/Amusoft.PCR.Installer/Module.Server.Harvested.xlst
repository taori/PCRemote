<xsl:stylesheet
	...
	<xsl:template match="@*|node()">
		...
		<!-- <xsl:variable name="capturedId" select="@Id"/> -->
		<!-- <xsl:copy> -->
		<!-- 	<xsl:apply-templates select="@*|node()"/> -->
		<!-- </xsl:copy> -->
		<!-- <xsl:apply-templates select="//wix:ComponentRef[@Id = $capturedId]"/> -->
	

	<!-- Template to remove ComponentRef elements with Blub attribute matching the captured Id -->
	<!-- <xsl:template match="wix:ComponentRef[@Id = $capturedId]" /> -->
