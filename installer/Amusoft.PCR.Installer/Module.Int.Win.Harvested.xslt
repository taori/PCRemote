...
<xsl:stylesheet
	...
	<!-- https://stackoverflow.com/questions/44765707/how-to-exclude-files-in-wix-toolset xsl is disgusting -->
	...
	<xsl:template match="wix:File/@Source">
		<xsl:attribute name="Source">
			<xsl:value-of select="concat(substring(.,0,19), '..\artifacts\msi\win-integration\', substring(., 20))"/>
		</xsl:attribute>
	</xsl:template>
